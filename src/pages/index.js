...
import { FaGithub, FaLinkedin, FaEnvelope, FaTwitter, FaRegFilePdf } from "react-icons/fa"
      ...
      <Wrapper className={className} >
        <Container className="page-content" fluid>
          <Row>
            <Col xs={4} className='avatar'>
              ...
              <div className="social">
                ...
                {siteConfig.social.twitter && <a className="social-link twitter" href="http://saikumarreddymokkala.uta.cloud/Resume.pdf">
                  <FaRegFilePdf className="social-icon" size="32" />
                </a>}
          ...
          <Row>
           ...
           <Row>
           <About title='Skills' text={siteConfig.authorskills}/>
          </Row>
